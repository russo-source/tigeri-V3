...
import OrganizationSubStepAForm from "@/components/onboarding/step-01-organization/OrganizationSubStepAForm";
...
const sections = [
  {
    ...
    subtitle: "Legal entity, size, and sector classification",
    Form: OrganizationSubStepAForm,
  },
];
...
export default function OrganizationStepForm() {
  ...
  useEffect(() => {
    const onNextSubsection = (event: Event) => {
      ...
      if (customEvent.detail?.stepId !== "1") {
        return;
      }

...
import RegulatoryFrameworkSubForm from "@/components/onboarding/step-04-compliance/RegulatoryFrameworkSubForm";
import DataClassificationSensitivitySubForm from "@/components/onboarding/step-04-compliance/DataClassificationSensitivitySubForm";
...
const sections = [
  {
    ...
    subtitle: "Applicable regulations and compliance obligations",
    status: "Active",
    Form: RegulatoryFrameworkSubForm,
  },
  {
    id: "04.B",
    title: "Data Classification & Sensitivity",
    subtitle: "Data types, sensitivity tiers, and handling requirements",
    status: "Incomplete",
    Form: DataClassificationSensitivitySubForm,
  },
];

export default function ComplianceStepForm() {
